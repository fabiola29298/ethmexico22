...
exports.lockController = exports.setController = exports.write = exports.validateWriteQuery = exports.read = exports.receipt = exports.list = exports.hash = void 0;
...
exports.validateWriteQuery = validateWriteQuery;
function read(query) {
    return __awaiter(this, void 0, void 0, function* () {
...
function lockController(tableId) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const message = yield GeneralizedRPC.call(this, "lockController", {
            token_id: tableId,
        });
        if (!this.token) {
            yield this.siwe();
