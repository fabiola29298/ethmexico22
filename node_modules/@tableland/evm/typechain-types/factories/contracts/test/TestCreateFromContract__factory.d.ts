...
import type { TestCreateFromContract, TestCreateFromContractInterface } from "../../../contracts/test/TestCreateFromContract";
declare type TestCreateFromContractConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;
export declare class TestCreateFromContract__factory extends ContractFactory {
    ...
    attach(address: string): TestCreateFromContract;
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): TestCreateFromContract;
}
export {};
//# sourceMappingURL=TestCreateFromContract__factory.d.ts.map